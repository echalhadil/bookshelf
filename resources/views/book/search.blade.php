...
@section('content')
    ...
    <div id='books' class="col-12 col-lg-10 pr-0 mt-5 mr-0">
        ...
        <div class="col-12 ">       
                    ...
                    <h4 class=" font-weight-bolder col-12  float-left mb-3 " > Results (@{{total}})</h4>
                    {{-- <div v-if='waiting' class=" col-12 p-0 m-auto  align-items-center text-center spinner-border text-primary " role="status"></div> --}}
                    ...
                    <div v-else='waiting' class="col-12 p-0 m-0  ">
                        ...
                        <div v-if='total!=0' v-for='book in books' class="col-12 col-lg-4 float-left p-0 m-0 mb-3 pr-1">
                            <!--book-->
                        ...
                        <div v-if='total==0'class="col-12 col-lg-4 float-left p-0 m-0 mb-3 pr-1">
                            <!--book-->
                        
                            <div class="col-12 d-flex p-0 pt-lg-1  mb-0 mb-lg-2" >
                                <div class="col-12 align-center m-auto"><h4 >Nothing Found :(</h4></div>
        ...
        new Vue(
            {
                ...
                mounted:function() {
                    this.getbooks('searchResult/{{$word}}');
                    this.getGenres();
